...
# THIS IS A DEBUGGING NIGHTMARE, GOD HELP ME IF I MESSED UP THE COPY AND PASTE.


class Keyboard:
    key_str: Dict[str, int] = {
        "BACKSPACE": 65288,
        "TAB": 65289,
        "LINEFEED": 65290,
        "CLEAR": 65291,
    ...
    key_id: Dict[int, str] = {_id: _str for _str, _id in key_str.items()}
...
class GameController:
    # TODO: Do the button mappings for game controllers
    pass
